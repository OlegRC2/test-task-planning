...
/*!**********************!*\
  !*** ./src/js/db.js ***!
  \**********************/
/*! exports provided: holidays, trips, workers, cityColor */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cityColor", function() { return cityColor; });
var holidays = ['1.1.2021', '2.1.2021', '3.1.2021', '4.1.2021', '5.1.2021', '6.1.2021', '7.1.2021', '8.1.2021', '23.2.2021', '8.3.2021', '1.5.2021', '9.5.2021', '12.6.2021', '4.11.2021'];
var trips = {
  alekseyLechashchiy: {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return countTrips; });
...
function countTrips(worker) {
  var visits = document.querySelector('.trip-counter'),
      days = document.querySelector('.day-counter');
  var tripsArr = []; // кол-во дней коммандировок

  for (var key in _db__WEBPACK_IMPORTED_MODULE_1__["trips"][worker]) {
    tripsArr.push(_db__WEBPACK_IMPORTED_MODULE_1__["trips"][worker][key]);
  }

  var newArr = tripsArr.filter(function (item, index) {
    return tripsArr.indexOf(item) === index;
  }); // фильтрация повторяющихся городов
...
/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../db */ "./src/js/db.js");




function createCalendar(year, month, worker) {
  var calendar = document.querySelector('#calendar');
  var mon = month - 1; // месяцы в JS идут от 0 до 11, а не от 1 до 12

  var d = new Date(year, mon);
  var md = new Date(year, mon, 0).getDate(); // кол-во дней в прошлом месяце

  var table = "<table>\n\t\t\t\t\t<tr>\n\t\t\t\t\t\t<th class=\"nameOfDay\">\u041F\u043E\u043D\u0435\u0434\u0435\u043B\u044C\u043D\u0438\u043A</th>\n\t\t\t\t\t\t<th class=\"nameOfDay\">\u0412\u0442\u043E\u0440\u043D\u0438\u043A</th>\n\t\t\t\t\t\t<th class=\"nameOfDay\">\u0421\u0440\u0435\u0434\u0430</th>\n\t\t\t\t\t\t<th class=\"nameOfDay\">\u0427\u0435\u0442\u0432\u0435\u0440\u0433</th>\n\t\t\t\t\t\t<th class=\"nameOfDay\">\u041F\u044F\u0442\u043D\u0438\u0446\u0430</th>\n\t\t\t\t\t\t<th class=\"nameOfDay\">\u0421\u0443\u0431\u0431\u043E\u0442\u0430</th>\n\t\t\t\t\t\t<th class=\"nameOfDay\">\u0412\u043E\u0441\u043A\u0440\u0435\u0441\u0435\u043D\u044C\u0435</th>\n\t\t\t\t\t</tr>\n\t\t\t\t\t<tr>"; // дни прошлого месяца для первого ряда
  // * * * 1  2  3  4

  for (var i = 0; i < getDay(d); i++) {
    var iDay = "".concat(md - getDay(d) + 1 + i, ".").concat(d.getMonth(), ".").concat(d.getFullYear()); // перебираемый день прошлого месяца

    if (i == 5 || i == 6) {
      // разметка выходных или праздников
      table += "<td class=\"grayDay\">\n\t\t\t\t\t\t\t".concat(md - getDay(d) + 1 + i, "\n\t\t\t\t\t\t\t").concat(_db__WEBPACK_IMPORTED_MODULE_3__["holidays"].includes(iDay) ? '<div class="dayOff">Праздник</div>' : '<div class="dayOff">Выходной</div>', "\n\t\t\t\t\t  </td>");
    } else if (_db__WEBPACK_IMPORTED_MODULE_3__["holidays"].includes(iDay)) {
      // разметка праздников
  ...
  while (d.getMonth() == mon) {
    var _iDay = "".concat(d.getDate(), ".").concat(d.getMonth() + 1, ".").concat(d.getFullYear()); // перебираемый день текущего месяца


    var trip = false; // текущий день совпадает с днем коммандировки

    var tableTd = ''; // значение ячейки календаря, если в этот день коммандировка

    if (worker) {
      // если сотрудник передан
      for (var key in _db__WEBPACK_IMPORTED_MODULE_3__["trips"][worker]) {
        if (key == _iDay) {
          trip = true;
          tableTd += "<td>\n\t\t\t\t\t\t\t\t\t".concat(d.getDate(), "\n\t\t\t\t\t\t\t\t\t<div class=\"dayOff\" style=\"background: ").concat(_db__WEBPACK_IMPORTED_MODULE_3__["cityColor"][_db__WEBPACK_IMPORTED_MODULE_3__["trips"][worker][key]], ";\">").concat(_db__WEBPACK_IMPORTED_MODULE_3__["trips"][worker][key], "</div>\n\t\t\t\t\t  \t\t\t</td>");
        }
      }
    }
    ...
    if (getDay(d) == 5 || getDay(d) == 6) {
      // разметка выходных или праздников
      table += "<td>\n\t\t\t\t\t\t".concat(d.getDate(), "\n\t\t\t\t\t\t").concat(_db__WEBPACK_IMPORTED_MODULE_3__["holidays"].includes(_iDay) ? '<div class="dayOff">Праздник</div>' : '<div class="dayOff">Выходной</div>', "\n\t\t\t\t\t  </td>");
    } else if (_db__WEBPACK_IMPORTED_MODULE_3__["holidays"].includes(_iDay)) {
      // разметка праздников
      table += "<td>\n\t\t\t\t\t\t".concat(d.getDate(), "\n\t\t\t\t\t\t<div class=\"dayOff\">\u041F\u0440\u0430\u0437\u0434\u043D\u0438\u043A</div>\n\t\t\t\t\t  </td>");
    } else if (trip) {
      // сотрудник выбран и текущий день совпадает с коммандировкой
      table += tableTd;
    } else {
  ...
  if (getDay(d) != 0) {
    for (var _i = getDay(d); _i < 7; _i++) {
      var _iDay2 = "".concat(_i - getDay(d) + 1, ".").concat(d.getMonth() + 1, ".").concat(d.getFullYear()); // перебираемый день следующего месяца


      if (_i == 5 || _i == 6) {
        // разметка выходных или праздников
        table += "<td class=\"grayDay\">\n\t\t\t\t\t\t\t".concat(_i - getDay(d) + 1, "\n\t\t\t\t\t\t\t").concat(_db__WEBPACK_IMPORTED_MODULE_3__["holidays"].includes(_iDay2) ? '<div class="dayOff">Праздник</div>' : '<div class="dayOff">Выходной</div>', "\n\t\t\t\t\t\t</td>");
      } else if (_db__WEBPACK_IMPORTED_MODULE_3__["holidays"].includes(_iDay2)) {
        // разметка праздников
        table += "<td class=\"grayDay\">\n\t\t\t\t\t\t\t".concat(_i - getDay(d) + 1, "\n\t\t\t\t\t\t\t<div class=\"dayOff\">\u041F\u0440\u0430\u0437\u0434\u043D\u0438\u043A</div>\n\t\t\t\t\t\t  </td>");
      } else {
...
/***/ "./src/js/modules/createSelectValue.js":
/*!*********************************************!*\
  !*** ./src/js/modules/createSelectValue.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return createSelectValue; });
/* harmony import */ var core_js_modules_es_array_concat_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat.js */ "./node_modules/core-js/modules/es.array.concat.js");
/* harmony import */ var core_js_modules_es_array_concat_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../db */ "./src/js/db.js");
